...
export class AttachmentItemComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private attachmentsService: AttachmentsService, private el: ElementRef) {
  ...
  submitRemoveAttachment(): void {
    this.attachmentsService
      .removeAttachment(this.attachment.id, this.removeAttachmentForm.value.comment)
      .then(() => {
