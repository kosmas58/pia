...
export class DPOPeopleOpinionsComponent implements OnInit {
  ...
  constructor(public _sidStatusService: SidStatusService, public _piaService: PiaService) {}
  ...
  ngOnInit(): void {
    ...
    if (this.pia.concerned_people_searched_opinion && this.pia.concerned_people_searched_opinion !== undefined) {
      this.searchedOpinionsForm.controls['searchStatus'].patchValue(this.pia.concerned_people_searched_opinion);
    ...
    if (
      ...
      this.searchedOpinionsForm.controls['searchContent'].patchValue(this.pia.concerned_people_searched_content);
    ...
    if (this.pia.people_names && this.pia.concerned_people_status !== undefined) {
      this.peopleForm.controls['peopleStatus'].patchValue(this.pia.concerned_people_status);
    }
    if (this.pia.concerned_people_opinion && this.pia.concerned_people_opinion != null && this.pia.concerned_people_opinion.length > 0) {
      this.peopleForm.controls['peopleOpinion'].patchValue(this.pia.concerned_people_opinion);
      this.peopleForm.controls['peopleOpinion'].disable();
    }
  ...
  concernedPeopleStatusFocusOut() {
    if (this.peopleForm.value.peopleStatus && this.peopleForm.value.peopleStatus >= 0) {
      this.pia.concerned_people_status = parseInt(this.peopleForm.value.peopleStatus, 10);
      this._piaService.update(this.pia).then(() => {
        this._sidStatusService.setSidStatus(this.pia, { id: 4 }, { id: 3 });
      });
    }
