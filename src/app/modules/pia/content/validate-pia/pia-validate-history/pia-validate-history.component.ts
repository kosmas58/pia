...
export class PiaValidateHistoryComponent implements OnInit {
  ...
  constructor(private el: ElementRef, public piaService: PiaService, public languagesService: LanguagesService) {}
  ...
  showValidationHistory() {
    return (this.pia.status === 2 || this.pia.status === 3) && this.pia.applied_adjustements && this.pia.rejected_reason;
  }
